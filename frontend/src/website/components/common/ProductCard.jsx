...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-2xl border border-[#ecdfc4]/80 bg-white transition-all duration-300 hover:-translate-y-1.5 hover:border-[#d4af6a] hover:shadow-[0_14px_36px_rgba(43,23,16,0.12)]">
      {/* Photo Block */}
